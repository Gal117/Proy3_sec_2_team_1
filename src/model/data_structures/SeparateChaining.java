...
public class SeparateChaining<Key extends Comparable <Key>, Value> {

    private static final int INIT_CAPACITY = 97;

    private int n;                                // number of key-value pairs
    private int m;                                // hash table size
    private SequentialSearch<Key, Value>[] st;  // array of linked-list symbol tables
    ...
    public int SeparateChainingHashSTSize(){
    	return m;
    }
    
    public int   chargeFactor() {
        return n/m;
    }
