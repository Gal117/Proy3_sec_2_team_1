...
public class DijkstraDios {
	 ...
	 */
	public DijkstraDios(Graph<Long,String,Double> G, long s) {
		this.s=s;
		indice=G.getIndice();
	...
	private void relax(Edge<Long,String,Double> e) {
		...
		if (distTo[w] > distTo[v] + (double)e.getInfo() + 1) {
			distTo[w] = distTo[v] + (double)e.getInfo() + 1;
			edgeTo[w] = e;
